...
public class PARCIAL extends PApplet {
...
// PROGRAMA
public void setup(){
  /* size commented out by preprocessor */; //VENTANA DE 1200X900PX
...
public void keyPressed(){
  if (key==' '){
      println(cont);
      tonos[cont] = PApplet.parseInt(random(270, 360));
 ...
 //PLAY - STOP AUDIO 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "PARCIAL" };
    if (passedArgs != null) {
